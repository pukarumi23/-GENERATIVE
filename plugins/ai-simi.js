...
if (!text) conn.reply(m.chat, `🎤💙 ¡Ara ara! Necesito que me digas algo para poder cantar contigo. ¿Qué quieres conversar conmigo? 💙🎤`, m);
try {
...
handler.command = ['miku', 'Miku', 'hatsune']
